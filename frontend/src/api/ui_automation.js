...
export function reorderElementGroups(data) {
  return request({
    url: '/ui-automation/element-groups/reorder/',
    method: 'post',
    data
  })
}
...
export function reorderElements(data) {
  return request({
    url: '/ui-automation/elements/reorder/',
    method: 'post',
    data
  })
}
