    ...
    <div class="card-container">
      <div class="filter-bar">
        ...
        <div class="filter-actions">
          <el-button :icon="Refresh" @click="fetchVersions">刷新</el-button>
        <el-button 
        ...
        <div class="inline-stats">
          ...
          <div class="stat-item">
            <span class="stat-number">{{ baselineVersionCount }}</span>
            <span class="stat-label">基线版本</span>
          </div>
          <div class="stat-item">
            <span class="stat-number">{{ selectedVersions.length }}</span>
...
const baselineVersionCount = computed(() => versions.value.filter(item => item.is_baseline).length)
