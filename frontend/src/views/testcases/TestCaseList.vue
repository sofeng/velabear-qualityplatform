    ...
    <div class="card-container">
      ...
      <el-table 
        ...
        <el-table-column label="操作" width="230" fixed="right">
          <template #default="{ row }">
            <el-button size="small" type="success" plain @click="goToUiAutomation(row)">UI自动化</el-button>
...
const goToUiAutomation = (testcase) => {
  router.push(`/ai-generation/testcases/${testcase.id}`)
}
