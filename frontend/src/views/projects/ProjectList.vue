    ...
    <div class="card-container">
      <div class="filter-bar">
        ...
        <div class="inline-stats">
          ...
          <div class="stat-item">
            <span class="stat-number">{{ activeProjectCount }}</span>
            <span class="stat-label">进行中</span>
          </div>
          <div class="stat-item">
            <span class="stat-number">{{ completedProjectCount }}</span>
...
const completedProjectCount = computed(() => projects.value.filter(item => item.status === 'completed').length)
