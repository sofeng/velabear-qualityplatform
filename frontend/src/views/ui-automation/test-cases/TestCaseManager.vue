                      ...
                      <div class="step-header">
                        <div class="step-left">
                          ...
                          >
                            ...
                            <el-option label="进入iframe" value="enterIframe" />
                            <el-option label="退出iframe" value="exitIframe" />
                        ...
                        <div v-if="needsInputValue(element.action_type)" class="step-param">
                          ...
                          <div style="display: flex; gap: 5px; flex: 1">
                            <el-input
                              ...
                              :placeholder="getInputPlaceholder(element.action_type)"
                              size="small"
                            />
                            <el-tooltip content="插入动态变量" placement="top" v-if="supportsDynamicVariables(element.action_type)">
...
const getInputPlaceholder = (actionType) => {
  if (actionType === 'switchTab') {
    return '输入索引(0,1...)或留空切换到最新'
  }
  return '请输入内容，支持变量如 ${random_phone()}'
}

const supportsDynamicVariables = (actionType) => {
  return actionType !== 'switchTab'
}
...
const needsElement = (actionType) => {
  return ['click', 'fill', 'getText', 'waitFor', 'hover', 'scroll', 'assert', 'enterIframe'].includes(actionType)
}
