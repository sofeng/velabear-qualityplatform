export const JIRA_REQUIREMENT_FIELD_DEFINITIONS = [
  { key: 'issuetype', label: '任务类型', visible: false },
  { key: 'issuekey', label: '需求编号', visible: true, minWidth: 140, filterLimit: 40, fixed: 'left' },
  { key: 'summary', label: '需求标题', visible: true, minWidth: 320, filterLimit: 20, overflow: true },
  ...
  { key: 'customfield_10765', label: '整体进度|延期原因', visible: true, minWidth: 180, filterLimit: 20 },
  ...
  { key: 'customfield_10602', label: '前端是否完成', visible: true, minWidth: 120, filterLimit: 20 },
  { key: 'customfield_10749', label: '前端预估工时', visible: true, minWidth: 120, filterLimit: 20 },
  { key: 'customfield_10603', label: '后端是否完成', visible: true, minWidth: 120, filterLimit: 20 },
  { key: 'customfield_10748', label: '后端预估工时', visible: true, minWidth: 120, filterLimit: 20 },
]

export const JIRA_REQUIREMENT_VISIBLE_FIELD_DEFINITIONS = JIRA_REQUIREMENT_FIELD_DEFINITIONS.filter(
  field => field.visible !== false
)

export const JIRA_REQUIREMENT_VISIBLE_FIELD_KEYS = JIRA_REQUIREMENT_VISIBLE_FIELD_DEFINITIONS.map(field => field.key)

export const JIRA_REQUIREMENT_HIDDEN_FIELD_KEYS = JIRA_REQUIREMENT_FIELD_DEFINITIONS
  .filter(field => field.visible === false)
  .map(field => field.key)

export const JIRA_REQUIREMENT_FIELD_LABELS = JIRA_REQUIREMENT_FIELD_DEFINITIONS.reduce((labels, field) => {
  labels[field.key] = field.label
  return labels
}, {})

export const JIRA_REQUIREMENT_ALL_FIELD_KEYS = new Set([
  ...JIRA_REQUIREMENT_VISIBLE_FIELD_KEYS,
  ...JIRA_REQUIREMENT_HIDDEN_FIELD_KEYS,
])
