    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_type', models.CharField(choices=[('deepseek', 'DeepSeek'), ('qwen', '通义千问'), ('siliconflow', '硅基流动'), ('other', '其他')], max_length=20, verbose_name='模型类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('pdf', 'PDF文档'), ('docx', 'Word文档'), ('txt', '文本文档')], max_length=10, verbose_name='文档类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', '等待中'), ('generating', '生成中'), ('reviewing', '评审中'), ('completed', '已完成'), ('failed', '失败')], default='pending', max_length=20, verbose_name='状态')),
