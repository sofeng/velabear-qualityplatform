...
class VersionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Version
        fields = ['id', 'name', 'description', 'is_baseline', 'is_default', 'projects', 'created_by', 'created_at', 'testcases_count']
...
class VersionCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Version
        fields = ['name', 'description', 'is_baseline', 'is_default', 'project_ids']
...
class VersionSimpleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Version
        fields = ['id', 'name', 'is_baseline', 'is_default']
